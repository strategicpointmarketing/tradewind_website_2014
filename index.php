	...
	<main class="nav-compensation" id="back-to-top" role="main">
		...
		<section class="tradewind-global-brands border-divider">
			<div class="wrapper pvs align-center">
				<h1 class="great-text mtn">Our Global Brands</h1>
				<h2 class="paragon-text normal capitalize">We only work with the best.</h1>
			</div>
		...
		<section class="tradewind-process">
			<div class="relative-container">
				<div class="wrapper relative pbs ptl js-slider">
					<ul class="slides">
						<li>
