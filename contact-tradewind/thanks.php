...
<body>
	...
	<main class="nav-compensation" role="main">
		...
		<section class="contact-tradewind-thanks">
			<div class="wrapper inner-content">
				<META HTTP-EQUIV="refresh" CONTENT="5;URL=/index.php">
				<h1 class="canon-text mtn align-center">Thank you for your submission!</h1>
				<p class="align-center">You will be redirected to the homepage in 5 seconds.</p>
			</form>
			</div>
		</section>
