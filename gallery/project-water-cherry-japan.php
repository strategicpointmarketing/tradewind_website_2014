...
<body>
    ...
    <main class="nav-compensation" role="main">
        ...
        <div class="wrapper inner-content">
            ...
            <h1 class="canon-text mvxs">Project: Water Cherry <span class="paragon-text">(Japan)</span></h1>
             ...
             <?php
                ...
                $galleryArray = $gallery->readImageDirectory('images/project--water-cherry-japan');
