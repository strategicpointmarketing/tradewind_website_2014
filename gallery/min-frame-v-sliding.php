...
<body>
    ...
    <main class="nav-compensation" role="main">
        ...
        <div class="wrapper inner-content">
            ...
            <h1 class="canon-text mvxs">Vertical Sliding Windows &amp; Doors <span class="paragon-text">(Minimal Frame)</span></h1>
             ...
             <?php
                ...
                $galleryArray = $gallery->readImageDirectory('images/min-frame--v-sliding');
