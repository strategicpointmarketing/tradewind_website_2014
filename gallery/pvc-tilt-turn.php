...
<body>
    ...
    <main class="nav-compensation" role="main">
        ...
        <div class="wrapper inner-content">
            ...
            <h1 class="canon-text mvxs">Tilt & Turn Windows <span class="paragon-text">(Performance PVC)</span></h1>
             ...
             <?php
                ...
                $galleryArray = $gallery->readImageDirectory('images/pvc--tilt-turn');
