...
<body>
    ...
    <main class="nav-compensation" role="main">
        ...
        <div class="wrapper inner-content">
            ...
            <h1 class="canon-text mvxs">Project: House In The Line Of Horizon <span class="paragon-text">(Poland)</span></h1>
             ...
             <?php
                ...
                $galleryArray = $gallery->readImageDirectory('images/project--horizon-poland');
