...
<body>
    ...
    <main class="nav-compensation" role="main">
        ...
        <div class="wrapper inner-content">
            ...
            <h1 class="canon-text mvxs">Project: Basset Road <span class="paragon-text">(United Kingdom)</span></h1>
             ...
             <?php
                ...
                $galleryArray = $gallery->readImageDirectory('images/project--basset-rd-uk');
