...
<body>
    ...
    <main class="nav-compensation" role="main">
        ...
        <div class="wrapper inner-content">
            ...
            <h1 class="canon-text mvxs">Swing Doors <span class="paragon-text">(Elite Aluminum)</span></h1>
             ...
             <?php
                ...
                $galleryArray = $gallery->readImageDirectory('images/aluminum--swing-doors');
