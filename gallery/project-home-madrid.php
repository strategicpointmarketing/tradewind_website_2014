...
<body>
    ...
    <main class="nav-compensation" role="main">
        ...
        <div class="wrapper inner-content">
            ...
            <h1 class="canon-text mvxs">Project: Single Home In Madrid <span class="paragon-text">(Spain)</span></h1>
             ...
             <?php
                ...
                $galleryArray = $gallery->readImageDirectory('images/project--single-house-madrid');
