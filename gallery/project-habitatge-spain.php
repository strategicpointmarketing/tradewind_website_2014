...
<body>
    ...
    <main class="nav-compensation" role="main">
        ...
        <div class="wrapper inner-content">
            ...
            <h1 class="canon-text mvxs">Project: Habitatge <span class="paragon-text">(Spain)</span></h1>
             ...
             <?php
                ...
                $galleryArray = $gallery->readImageDirectory('images/project--habitatge-spain');
