...
<body>
    ...
    <main class="nav-compensation" role="main">
        ...
        <div class="wrapper inner-content">
            ...
            <h1 class="canon-text mvxs">Tilt & Turn Windows <span class="paragon-text">(Elite Aluminum)</span></h1>
             ...
             <?php
                ...
                $galleryArray = $gallery->readImageDirectory('images/aluminum--tilt-turn');
