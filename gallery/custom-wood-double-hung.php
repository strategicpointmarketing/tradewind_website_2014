...
<body>
    ...
    <main class="nav-compensation" role="main">
        ...
        <div class="wrapper inner-content">
            ...
            <h1 class="canon-text mvxs">Double Hung Windows <span class="paragon-text">(Custom Wood)</span></h1>
             ...
             <?php
                ...
                $galleryArray = $gallery->readImageDirectory('images/wood--double-hung');
