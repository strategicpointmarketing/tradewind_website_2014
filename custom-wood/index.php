...
<body>
	...
	<main class="nav-compensation" id="back-to-top" role="main">
				...
				<div class="wrapper">
						<div class="gd-5of12 gd-columns description pn">
							<div class="white-text align-right pvm prm">
								<h1 class="great-text semibold mtn">Custom Wood</h1>
								...
								<p class="petite-text mtxs">Click a button above to learn more about Tradewind's custom wood options.</p>
							</div>
		...
		<section class="custom-wood-info">
			<div class="relative-container info-img custom-wood">
				&nbsp;
			</div>
		</section>
